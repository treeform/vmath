...
proc dumpMat4(lines: var seq[string], label: string, value: Mat4f) =
  ...
  lines.appendLine("[")
  lines.appendLine("  " & fmt(value.arr[0][0]) & " " & fmt(value.arr[1][0]) & " " & fmt(value.arr[2][0]) & " " & fmt(value.arr[3][0]) )
  lines.appendLine("  " & fmt(value.arr[0][1]) & " " & fmt(value.arr[1][1]) & " " & fmt(value.arr[2][1]) & " " & fmt(value.arr[3][1]) )
  lines.appendLine("  " & fmt(value.arr[0][2]) & " " & fmt(value.arr[1][2]) & " " & fmt(value.arr[2][2]) & " " & fmt(value.arr[3][2]) )
  lines.appendLine("  " & fmt(value.arr[0][3]) & " " & fmt(value.arr[1][3]) & " " & fmt(value.arr[2][3]) & " " & fmt(value.arr[3][3]) )
  lines.appendLine("]")
...
proc main() =
  ...
  let
    ...
    matB = mat4f(
      vec4f(-10.0f, -20.0f, -30.0f, -40.0f),
      vec4f(50.0f, 60.0f, 70.0f, 80.0f),
      vec4f(90.0f, 100.0f, 110.0f, 120.0f),
      vec4f(130.0f, 140.0f, 150.0f, 160.0f)
    )
